...
pub trait TetSandbox: Send + Sync {
    ...
    /// Export the manifest of an active or hibernating agent.
    ...
    /// Query the active Vector-VFS semantic memory of a running/hibernating Tet.
...
pub enum TetError {
    ...
    /// A WASI capability was requested that violates the security policy.
    ...
    /// Cartridge (Component Model) execution failed.

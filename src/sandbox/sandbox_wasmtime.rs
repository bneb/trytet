...
impl WasmtimeSandbox {
    ...
    pub fn new_with_engine(
        ...
        // Create CartridgeManager sharing the same Engine
    ...
    pub fn with_gateway(mut self, gateway: Arc<crate::gateway::Gateway>) -> Self {
    ...
    async fn execute_inner(
        ...
        // Derive tenant-namespaced Oracle cache dir
        ...
        tokio::fs::create_dir_all(&oracle_cache_dir)
            .await
        ...
        // Restore inference sessions from snapshot (Context Replay)
        ...
        // Serialize inference sessions for snapshot
            ...
            if let Some(msg) = violation {
                ...
                return Ok(TetExecutionResult {
                    ...
                    status: ExecutionStatus::Crash(CrashReport {
                        error_type: CrashType::EconomicViolation,

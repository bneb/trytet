use crate::registry::identity::IdentityRegistry;
...
pub enum RecoveryError {
    ...
    Registry(#[from] crate::registry::identity::RegistryError),
...
impl RecoveryOrchestrator {
    pub fn new(sandbox: Arc<WasmtimeSandbox>, registry: Arc<IdentityRegistry>) -> Self {
